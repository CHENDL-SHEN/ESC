...
def get_params():
    ...
    parser.add_argument('--Qmodel_path', default='experiments/models/train_Q_sal/2022-09-07 19:39:04.pth', type=str)#
    
    parser.add_argument(
        '--Cmodel_path', default='experiments/models/train_sp_cam_VOC_sal/2022-09-10 16:54:03.pth', type=str)  # 
...
class evaluator:
    ...
    def get_cam(self, images, ids, Qs,beta,it):
        with torch.no_grad():
            cam_list = []
            ...
            for s, q in zip(self.scale_list, Qs):
                ...
                if(self.SP_CAM):
                    logits,x4 = self.C_model(scaled_images, q,pcm=beta,it=it)
                else:
    ...
    def evaluate(self, C_model,Q_model=None,beta=8,ite=10):
