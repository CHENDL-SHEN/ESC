...
def get_params():
    ...
    parser.add_argument('--saliency_map_dir', default= 'VOC2012/VOCdevkit/VOC2012/saliency_map/', type=str)
...
def main(args):
    ...
    train_dataset = VOC_Dataset_For_trainQ_withcam(
        args.data_dir, args['saliency_map_dir'],args.pse_path,args.domain,train_transform)
