...
###############################################################################
parser.add_argument('--tag', default='ours-spam', type=str)
...
if __name__ == '__main__':
    ...
    model_path='experiments/model/train_seg_for_full/2021-11-15 00:36:05.pth'
    ...
    # pred_dir ='finalmodel/base_sal/our-resnest50/deeplabv3+resnet101/output_labels_'+str(args.domain)+'/'
    pred_dir ='finalmodel/full_sup/deeplabv3+resnet101/output_labels_'+str(args.domain)+'/'
    ...
    dataset = VOC_Dataset_For_Evaluation_test(args.data_dir, args.domain)
