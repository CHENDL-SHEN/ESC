...
os.environ["CUDA_VISIBLE_DEVICES"] = "5,4,1,0"
...
def get_params():
    ...
    # Network
    ###############################################################################
    parser.add_argument('--architecture', default='SANET_Model_new0', type=str)
    ...
    parser.add_argument('--tag', default='Scam_batch16_baseline0', type=str)
