...
if __name__ == '__main__':
    try:
        ...
        save_path="/media/ders/zhangyumin/PuzzleCAM/experiments/res/train_eps_spimg"
        Q_model = fcnmodel.SpixelNet1l_bn().cuda()
        ...
        for filename in train_list:
            ...
            img_id=img_id.split('\n')[0]
            image = cv.imread(os.path.join(path,img_id+ '.png'))
            ...
            sp_image= poolfeat(image.cuda(),prob)
