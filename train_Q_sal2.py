...
def get_params():
    ...
    parser.add_argument('--domain', default='train_aug2', type=str)#***********调#@2
    parser.add_argument('--pretrain', default=False, type=str2bool)#***********调#@4
    parser.add_argument('--pse_path', default='experiments/res/numpy101', type=str)#***********调#@5

    parser.add_argument('--tag', default='train_Q_withPse_uss', type=str)
...
def main(args):
    ...
    train_dataset = VOC_Dataset_For_trainQ_withcam(
        args.data_dir, 'VOC2012/VOCdevkit/VOC2012/saliency_unsupervised_model/',args.pse_path,args.domain,train_transform)
